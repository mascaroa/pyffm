...
class TestEngine(unittest.TestCase):
    ...
    def test_basic_train(self):
        train_data = np.array([[(0, 0, 1), (1, 1, 1), (2, 2, 1), (3, 3, 1)],
                               [(0, 4, 1), (1, 5, 1), (2, 2, 1), (3, 3, 1)],
                               [(0, 6, 1), (1, 7, 1), (2, 8, 1), (3, 9, 1)]])
        self.ctr_engine.train(train_data)
        print(self.ctr_engine.predict(np.array([(0, 0, 1), (1, 1, 1), (2, 2, 1), (3, 3, 1)])))
        print(self.ctr_engine.predict(np.array([(0, 4, 1), (1, 5, 1), (2, 2, 1), (3, 3, 1)])))
        print(self.ctr_engine.predict(np.array([(0, 6, 1), (1, 7, 1), (2, 8, 1), (3, 9, 1)])))
